...
<div class="section">
	...
	<p><a href="<?php print_unescaped($theme->getBaseUrl()); ?>" target="_blank"><?php p($theme->getTitle()); ?></a> 4.1.0</p>
	<!--<p><?php include('settings.development.notice.php'); ?></p>COSTUMIZED BY 247  <?php p(OC_Util::getHumanVersion()) ?>-->
</div>
